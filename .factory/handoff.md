...
- YouTube and TED capture limited to official timed transcript text already exposed on the active source page; no media fetching, scraping bypass, transcription, summary, or rewrite path exists.
...
- Production budgets: site JavaScript **0.92 KB**, CSS **12.41 KB**, self-hosted fonts **84.82 KB** total, mobile hero **44 KB AVIF / 56 KB WebP**, unpacked extension **138.21 KB**.
